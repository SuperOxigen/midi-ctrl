...
typedef struct {
  ...
  uint32_t nanoseconds;  /* 0 to 999,999 */
} system_time_t;
...
bool_t SystemTimeSecondsDelta(
  system_time_t const *time_a, system_time_t const *time_b, uint32_t *seconds);
bool_t SystemTimeMillisecondsDelta(
  system_time_t const *time_a, system_time_t const *time_b, uint32_t *mseconds);
bool_t SystemTimeNanosecondsDelta(
  system_time_t const *time_a, system_time_t const *time_b, uint32_t *nseconds);
...
bool_t SystemTimeIncrementMilliseconds(system_time_t *time, uint32_t mseconds);
bool_t SystemTimeIncrementNanoseconds(system_time_t *time, uint32_t nseconds);

bool_t SystemTimeDecrementSeconds(system_time_t *time, uint32_t seconds);
bool_t SystemTimeDecrementMilliseconds(system_time_t *time, uint32_t mseconds);
bool_t SystemTimeDecrementNanoseconds(system_time_t *time, uint32_t nseconds);
